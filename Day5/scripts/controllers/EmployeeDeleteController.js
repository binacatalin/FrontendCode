...
//
//
hrApp.controller('EmployeeDeleteController', ['$scope', '$http', '$location', 'CommonResourcesFactoryBackup', 'EmployeeService', 'DepartmentsService', 'JobsService',
    function ($scope, $http, $location, CommonResourcesFactoryBackup, EmployeeService, DepartmentsService, JobsService) {
        ...
        $scope.deleteEmployee = function () {
            $http({url: CommonResourcesFactoryBackup.deleteEmployeeUrl + "/" + $scope.employee.employeeId, method: 'DELETE'})
                .success(function (data) {
                    alert("Employee("+$scope.employee+") deleted: " + status);
                    // $scope.employee = data;
                    // $location.url('/employeeView/' + $scope.employee.employeeId);
                })
                .error(function (data, status, headers, config) {
